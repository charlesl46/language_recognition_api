...
if __name__ == "__main__":
    ...
    df = pd.read_csv("collected_dataset/dataset_collected.csv")
    ...
    with open("collected_dataset/svm_model.pkl","wb") as file:
        pickle.dump(grid_search,file)
    C.log("SVM model serialized")

    with open("collected_dataset/w2vec_model.pkl","wb") as file:
